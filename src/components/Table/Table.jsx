    ...
    render() {
        ...
        return (
            <section>
                ...
                />
                <div ref={ div => this._bottom = div } style={{ padding: '4rem', opacity: this.state.atBottom ? 1 : 0 }} className="ui segment endOfTable">
                        <p></p>
