    ...
    _createClass(File, [{
        ...
        value: function addFile(file, noTrigger) {
            ...
            var createFile = function createFile(event, file) {
                ...
                if (_this2.props.multiple && noTrigger !== true) {
                    files.push(data);
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    defaultFiles,
                    this.props.multiple ? '' : !_.isEmpty(file) ? _react2.default.createElement('input', { type: 'hidden', name: '' + this.props.name, value: file.url || file._id }) : '',
