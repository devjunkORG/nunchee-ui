...
var Textarea = function (_React$Component) {
    ...
    _createClass(Textarea, [{
        ...
        value: function render() {
            ...
            var editorState = !_.isEmpty(this.props.editorState) ? this.props.editorState : null;
            if (this.props.rich) {
                return _react2.default.createElement(
                    ...
                    _react2.default.createElement(_draftWysiwyg2.default, _extends({
                        ref: function ref(editor) {
                            return _this2._editor = editor;
                        },
                        value: editorState
                    }, this.props, {
                        blockTypes: _index.Blocks }))
                );
            } else {
                return _react2.default.createElement(
                    'div',
