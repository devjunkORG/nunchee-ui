...
var Form = function (_React$Component) {
    ...
    function Form() {
        ...
        _this.initializeForm = _this.initializeForm.bind(_this);
    ...
    _createClass(Form, [{
        ...
        value: function initializeForm() {
            ...
            formOptions.onSuccess = function (e, fields) {
                ...
                if (!_this2.props.onSubmit && action.length < 1) {
                    return false;
                }
                $(_this2._form).closest('.ui.modal').modal('hide');
                _this2.submit(null, action, fields);
            };
            formOptions.onFailure = function (errors, fields) {
                return false;
            };
