...
var Select = function (_React$Component) {
    ...
    _createClass(Select, [{
        ...
        value: function componentWillReceiveProps(props) {
            ...
            var dropdown = $(this._select);
            setTimeout(function () {
                dropdown.dropdown('set selected', props.defaultValue);
            }, 500);
        }
    }, {
        key: 'createSelect',
        ...
        value: function getDefault() {
            if (this.props.defaultValue && this.props.options && this.props.options instanceof Array) {
                ...
                var withId = _.find(this.props.options, { _id: this.props.defaultValue });
                var withValue = _.find(this.props.options, { value: this.props.defaultValue });
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        this.props.options && this.props.options instanceof Array ? this.props.options.map(function (v, i) {
                            ...
                            return _react2.default.createElement(
                                'div',
                                { key: i, className: 'item', 'data-value': v[_this2.props.keyName || '_id'] || v.value },
                                (0, _nuncheeLanguage2.default)()._(v.name || v.title)
                            );
                        }) : ''
                    )
                )
